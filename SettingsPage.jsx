...
export const SettingsPage = () => {
  ...
  // Mock data
  const collaborators = [
    { id: 1, name: 'John Smith', email: 'john@example.com', role: 'Editor', permissions: ['View', 'Comment', 'Upload Proof'] },
    { id: 2, name: 'Emma Davis', email: 'emma@example.com', role: 'Viewer', permissions: ['View', 'Comment'] },
  ];

  const templates = [
    { id: 1, name: 'Monthly Rent', category: 'Housing', fields: ['Amount', 'Due Date', 'Property'] },
    { id: 2, name: 'Grocery Shopping', category: 'Food', fields: ['Store', 'Amount', 'Items'] },
    { id: 3, name: 'Utility Bills', category: 'Utilities', fields: ['Provider', 'Amount', 'Period'] },
  ];
            ...
            <Card className="p-6">
              ...
              <div className="space-y-4">
                {collaborators.map((collaborator) => (
                  <div key={collaborator.id} className="flex items-center justify-between p-4 bg-muted/50 rounded-lg">
