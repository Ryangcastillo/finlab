...
export const EnhancedAuthPage = () => {
  ...
  const isFormValid = () => {
    if (isSignUp) {
      ...
      return (
        formData.email && formData.password && validationStates.email?.isValid
      );
    }
  };
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-primary-foreground">
          <div className="mb-8">
            ...
            <p className="text-xl text-primary-foreground/80 leading-relaxed">
              Join thousands of users who trust FinLab to manage their shared
              expenses, track goals, and build better financial habits together.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="fade-in-up">
              <EnhancedInput
                ...
                validation={
                  isSignUp ? validationRules.password : validationRules.required
                }
