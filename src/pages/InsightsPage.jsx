  ...
  const aiInsights = [
    {
      ...
      description:
        'You could save $45/month by buying shampoo in bulk instead of individual bottles.',
      impact: '$540/year',
      icon: Lightbulb,
    },
    {
      ...
      description:
        "At your current saving rate, you'll reach your vacation goal 2 months early.",
    ...
    },
    {
      ...
      description:
        'Your entertainment expenses increased by 25% this month. Consider setting a budget.',
        ...
        <main className="flex-1 p-6 space-y-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Track your progress and discover ways to optimize your finances.
            </p>
          </div>
